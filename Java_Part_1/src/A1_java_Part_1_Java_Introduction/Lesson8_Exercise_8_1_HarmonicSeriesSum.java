 ...
 */
public class Lesson8_Exercise_8_1_HarmonicSeriesSum { //saved as Lesson8_Exercise_8_1_HarmonicSeriesSum.java 
...
//Try computing the sum for n=1000, 5000, 10000, 50000, 100000.
		double sum=0.0;	// create double variable sum and initiate it to 0.0.
			...
			for (int n=1; n<=max; n++){	//Start loop that sum 1+ 1/n that increased by 1 every loop.
			double x=1.0/n;				//calculate 1/n in  x variable per loop.
			sum +=x;					//Accumulate double numbers in  sum variable.
		}
			//Print
		System.out.println("Sum of 1+ 1/2+ ...1/"+max+" = "+sum);
		}	
